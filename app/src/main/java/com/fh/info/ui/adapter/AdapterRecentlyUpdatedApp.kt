...
import com.fh.info.databinding.AdapterRecentlyUpdatedAppBinding
...
class AdapterRecentlyUpdatedApp : RecyclerView.Adapter<AdapterRecentlyUpdatedApp.RecentlyUpdatedAppViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecentlyUpdatedAppViewHolder {
        val binding =
            AdapterRecentlyUpdatedAppBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return RecentlyUpdatedAppViewHolder(binding)
    }

    override fun onBindViewHolder(holder: RecentlyUpdatedAppViewHolder, position: Int) {
    ...
    inner class RecentlyUpdatedAppViewHolder(private val binding: AdapterRecentlyUpdatedAppBinding) :
